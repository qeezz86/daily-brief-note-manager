...
select throws_ok($$ select public.test_restore_prep_job(repeat('c',64),1,'full','include') $$,'23514','RESTORE_OPERATIONAL_HISTORY_BLOCKED','16 operational history include blocked');
