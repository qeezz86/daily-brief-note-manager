...
export function backupSnapshotFixture(profile: BackupProfile = 'core'): BackupSnapshot {
  ...
  if (profile === 'full') {
    ...
    data.importJobItems = [{ id: ids.item, jobId: ids.job, postId: ids.post, itemIndex: 0, externalKey: 'item-1', payloadFingerprint: '28bee001321848192954f5b913d6c226994f6014bc2db2be1425a4ccb1f50e23', title: '게시물', categoryId: 'economy', validationStatus: 'ready', normalizedPayload: { schemaVersion: 1, externalKey: 'item-1', contentGroup: 'news', content: { category_id: 'economy', title: '게시물' }, tracking: null }, warningAcknowledged: false, contentStatus: 'imported', trackingStatus: 'not_present', contentAttemptCount: 1, trackingAttemptCount: 0, contentErrorCode: null, contentErrorMessage: null, contentRetryable: false, trackingErrorCode: null, trackingErrorMessage: null, trackingRetryable: false, topicCount: null, reusedTopicCount: null, createdTopicCount: null, updateCount: null, followupCount: null, sourceLinkCount: null, contentStartedAt: '2026-07-15T00:00:00Z', contentCompletedAt: '2026-07-15T00:00:30Z', trackingStartedAt: null, trackingCompletedAt: null, createdAt: '2026-07-15T00:00:00Z', updatedAt: '2026-07-15T00:01:00Z' }]
    data.importJobItemAttempts = [{ id: ids.attempt, jobItemId: ids.item, stage: 'content', attemptNo: 1, status: 'imported', safeErrorCode: null, safeErrorMessage: null, retryable: false, startedAt: '2026-07-15T00:00:00Z', completedAt: '2026-07-15T00:00:30Z' }]
  }
