...
export function BriefingPromptPreview({ context, prompt, promptCopyDisabled = false }: { context: NewsBriefingPromptContext; prompt: string; promptCopyDisabled?: boolean }) {
