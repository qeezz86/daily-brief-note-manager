...
- category/tag catalog: `context=view`, `per_page=100`, 최대 taxonomy별 20 pages·2,000 terms. 기존 term 할당에는 built-in taxonomy의 `assign_terms=edit_posts`를 사용하므로 catalog 조회를 위해 `manage_categories`를 요구하지 않는다.
